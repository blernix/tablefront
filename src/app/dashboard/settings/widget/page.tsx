...
import { Crown, Save, RotateCcw, Palette, Eye, Smartphone, Monitor, Copy, Check, Square, Type, Radius, Layout, Settings, Globe } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 pt-4">
          ...
          <div>
             <div className="flex items-center gap-3">
                <h1 className="text-4xl font-light text-[#2A2A2A]">Personnalisation du bouton flottant</h1>
               <ProBadge />
             </div>
             ...
             <div className="flex items-center gap-4">
               ...
               <div>
                 ...
                 <p className="text-sm text-amber-800">
                    Passez au plan Pro pour personnaliser les couleurs, la police et le style de votre bouton flottant.
       ...
       <div className="grid gap-6 lg:grid-cols-2">
                ...
                {activeTab === 'form' && (
                  <>
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-[#666666] mt-1">
                        Arrondi des coins des boutons et champs (ex: 0px carré, 4px légèrement arrondi, 8px arrondi)
                      </p>
                    </div>
                  </>
                )}
                           ...
                           <p className="text-sm text-blue-900 mb-2">
                            ...
                            <div className="flex items-center justify-between bg-white p-3 rounded border overflow-hidden">
                              <code className="text-sm text-blue-700 break-all">
                               {process.env.NEXT_PUBLIC_FRONTEND_URL || 'http://localhost:3000'}/embed/reservations/{currentSlug}
                             </code>
                             <Button
                               variant="outline"
                               size="sm"
                               onClick={() => copyToClipboard(`${process.env.NEXT_PUBLIC_FRONTEND_URL || 'http://localhost:4000'}/embed/reservations/${currentSlug}`, 'current-link')}
                             >
                           ...
                           <div className="space-y-4">
                             <div>
                               <Label htmlFor="customSlug">Personnaliser mon lien</Label>
                                <div className="flex flex-wrap gap-2 mt-2">
                                  <span className="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-sm text-gray-500 flex-shrink min-w-0 truncate">
                                   {process.env.NEXT_PUBLIC_FRONTEND_URL || 'http://localhost:3000'}/embed/reservations/
                                 </span>
                                  <Input
                                    id="customSlug"
                                    type="text"
                                  ...
                                  <Button
                                    ...
                                    disabled={isSaving || !customSlug || customSlug.length < 3 || !slugAvailability?.available}
                               ...
                               {isCheckingAvailability && (
                                 <p className="text-xs text-blue-600 mt-2">Vérification de la disponibilité...</p>
                               )}
                               ...
                               <p className="text-xs text-gray-500 mt-2">
                                 Utilisez uniquement des lettres minuscules, des chiffres et des tirets (3-50 caractères)
                               </p>
                             </div>
                           </div>
                         ) : (
                           <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
                             <div className="flex items-center justify-between">
                               <div className="flex items-center gap-3">
                                 ...
                                 <div>
                                   <p className="font-medium text-[#2A2A2A]">Personnalisation du lien</p>
         ...
         <Card>
           <CardHeader>
             ...
             <CardDescription>Prévisualisation du bouton flottant avec vos paramètres</CardDescription>
           </CardHeader>
           <CardContent>
             <div className="space-y-4">
               {/* Device Toggle */}
               ...
               <div className={`border border-[#E5E5E5] rounded-lg overflow-hidden bg-white shadow-sm ${
                 ...
                 <div className="relative bg-gradient-to-br from-gray-50 to-gray-100" style={{ height: '400px' }}>
                   ...
                   <div className="absolute bottom-4 right-4">
                     <button
                       ...
                       style={{
                         ...
                         borderRadius: buttonStyle === 'round' ? '25px' : buttonStyle === 'square' ? '4px' : '20px',
                       ...
                       onMouseEnter={(e) => {
                         if (buttonHoverColor) {
                           e.currentTarget.style.backgroundColor = buttonStyle === 'minimal' ? buttonHoverColor : buttonHoverColor;
                           e.currentTarget.style.color = buttonStyle === 'minimal' ? '#FFFFFF' : buttonTextColor;
                   ...
                   <div className="p-6">
                     <div className="mb-4">
                       <div className="h-6 bg-gray-300 rounded mb-2" style={{ fontFamily: fontFamily }}></div>
             ...
             <div className="p-6">
                  ...
                  <div className="bg-white rounded-lg shadow-lg" style={{ 
                    ...
                    <div className="p-6 space-y-4">
                      <div>
                        <label className="block text-sm font-medium mb-2" style={{ color: secondaryColor }}>Nom</label>
                        <input type="text" className="w-full p-3 border rounded-lg" style={{ borderRadius: borderRadius, borderColor: '#E5E5E5' }} placeholder="Jean Dupont" />
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium mb-2" style={{ color: secondaryColor }}>Email</label>
                          <input type="email" className="w-full p-3 border rounded-lg" style={{ borderRadius: borderRadius, borderColor: '#E5E5E5' }} placeholder="jean@example.com" />
                        </div>
                        <div>
                          <label className="block text-sm font-medium mb-2" style={{ color: secondaryColor }}>Téléphone</label>
                          <input type="tel" className="w-full p-3 border rounded-lg" style={{ borderRadius: borderRadius, borderColor: '#E5E5E5' }} placeholder="+33612345678" />
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium mb-2" style={{ color: secondaryColor }}>Date</label>
                          <input type="date" className="w-full p-3 border rounded-lg" style={{ borderRadius: borderRadius, borderColor: '#E5E5E5' }} />
                        </div>
                        <div>
                          <label className="block text-sm font-medium mb-2" style={{ color: secondaryColor }}>Personnes</label>
                          <select className="w-full p-3 border rounded-lg" style={{ borderRadius: borderRadius, borderColor: '#E5E5E5' }}>
