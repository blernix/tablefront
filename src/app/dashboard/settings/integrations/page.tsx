...
import { Copy, Check, ExternalLink, Code2, Globe, Zap, Palette, Crown, Eye, Smartphone, Monitor } from 'lucide-react';
...
export default function IntegrationsPage() {
  ...
  const { restaurant, isLoading: isRestaurantLoading, error: restaurantError, fetchRestaurant } = useRestaurantStore();
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-[#666666]">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Instagram/Facebook Bio :</strong> Ajoutez le lien dans votre bio</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#0066FF] mt-0.5">•</span>
                <span><strong>QR Code :</strong> Générez un QR code pointant vers ce lien</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#0066FF] mt-0.5">•</span>
                <span><strong>Email Marketing :</strong> Bouton &quot;Réserver maintenant&quot;</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#0066FF] mt-0.5">•</span>
                <span><strong>Google Maps :</strong> Lien de réservation dans votre profil</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#666666]">
                    Bouton toujours visible qui flotte sur votre site. Recommandé pour une meilleure conversion.
                  </p>
                </div>
              </div>
              <div className="bg-white p-3 rounded border">
                <p className="text-xs text-blue-700">
                  ✅ <strong>Avantages :</strong> Toujours visible, meilleur taux de conversion, 
                  pas de conflit avec la mise en page, personnalisable sans code
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                ...
                <div>
                   <h3 className="text-sm font-medium text-[#2A2A2A] flex items-center gap-2">
                     ...
                     {restaurant?.subscription?.plan && (
                       <span className={`text-xs ${getPlanDisplay(restaurant.subscription.plan).badgeClass} px-2 py-1 rounded`}>
              ...
              <p className="text-xs text-blue-700 mt-2">
                💡 Votre lien unique : {process.env.NEXT_PUBLIC_FRONTEND_URL || 'http://localhost:3000'}/embed/reservations/{shortCode}
              </p>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 p-4 rounded-lg">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h3 className="text-sm font-medium text-[#2A2A2A] flex items-center gap-2">
                    🔐 Système Classique
                    <span className="text-xs bg-gray-200 text-gray-600 px-2 py-1 rounded">Legacy</span>
                  </h3>
            ...
            <div className="bg-green-50 border border-green-200 p-4 rounded-md">
              <p className="text-sm text-green-900">
                🎯 <strong>Système Dynamique :</strong> Ces codes récupèrent automatiquement vos configurations depuis le dashboard. 
                Modifiez les couleurs ou le style → ça se met à jour instantanément sur votre site sans recopier le code !
              </p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 p-4 rounded-md">
            <p className="text-sm text-blue-900">
              💡 <strong>Astuce :</strong> Placez ce code juste avant la balise <code>&lt;/body&gt;</code> pour de meilleures performances.
            </p>
          </div>
        </div>
      ),
...

  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-sm text-[#666666]">
          Intégrez le widget dans WordPress en utilisant un bloc HTML personnalisé ou le Custom HTML widget.
        </p>

        <div className="space-y-3">
          <p className="text-sm font-medium text-[#2A2A2A]">Méthode 1 : Éditeur de blocs (Gutenberg)</p>
...

  {
    ...
    content: (
      <div className="space-y-4">
         <p className="text-sm text-[#666666]">
            Intégrez le widget dans votre site Wix en utilisant l&apos;élément &quot;HTML intégré&quot;.
         </p>
...

  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-sm text-[#666666]">
          Intégrez le widget dans votre boutique Shopify en utilisant une section HTML personnalisée.
        </p>
