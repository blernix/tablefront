        ...
        <div className="flex flex-col h-full min-h-screen">
            ...
            <div className="px-4 md:px-6">
              <div className="flex overflow-x-auto py-2 -mx-1">
                {['Dashboard', 'Plats', 'PDF & QR'].map((label, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-2 px-4 py-2.5 mx-1 bg-[#E5E5E5] animate-pulse w-32 h-10"
                  />
                ))}
              </div>
            </div>
          ...
          <div className="flex-1 overflow-auto p-4 md:p-6">
            <div className="space-y-6">
              <div className="h-8 bg-[#E5E5E5] animate-pulse w-48" />
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="h-24 bg-[#E5E5E5] animate-pulse" />
                ))}
              </div>
            </div>
          </div>
