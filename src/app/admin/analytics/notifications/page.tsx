...
export default function NotificationAnalyticsPage() {
  ...
  const fetchAnalytics = async () => {
    try {
      setIsLoading(true);
      setError('');
      const response = await apiClient.admin.getNotificationAnalytics();
  ...
  const handleExport = async () => {
    try {
      await apiClient.admin.exportNotificationAnalytics();
    } catch (error) {
      console.error('Export failed:', error);
      alert('Erreur lors de l\'exportation : ' + (error instanceof Error ? error.message : 'Unknown error'));
    }
  };
        ...
        <div className="container mx-auto flex items-center justify-between px-4 py-4">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex gap-4">
              ...
              <Button variant="link" className="font-semibold border-b-2 border-blue-600">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3 text-red-700">
                ...
                <div>
                  ...
                  <Button variant="ghost" size="sm" className="mt-2 text-red-700" onClick={fetchAnalytics}>
                    Réessayer
                  </Button>
                </div>
              </div>
