  ...
  const openCookieSettings = () => {
    try {
      if (!isTarteaucitronReady()) {
        alert(
          'Le gestionnaire de cookies est en cours de chargement. Veuillez réessayer dans quelques instants.'
        );
        return;
      }
      ...
      const tryOpenPanel = () => {
        try {
          ...
          if (retryCount < maxRetries) {
            ...
            alert(
              "Impossible d'ouvrir les paramètres de cookies. Veuillez recharger la page et réessayer."
            );
          }
        }
      };
      ...
      const tryAcceptAll = () => {
        try {
          ...
          if (retryCount < maxRetries) {
            ...
            alert(
              "Impossible d'accepter tous les cookies. Veuillez recharger la page et réessayer."
            );
          }
        }
      };
      ...
      const tryRefuseAll = () => {
        try {
          ...
          if (retryCount < maxRetries) {
            ...
            alert(
              'Impossible de refuser tous les cookies. Veuillez recharger la page et réessayer.'
            );
          }
        }
      };
        ...
        <div className="bg-white border-2 border-[#E5E5E5] p-10">
          <div className="mb-10">
            ...
            <p className="text-[#666666] font-light">
              Cette page vous explique comment nous utilisons les cookies et comment vous pouvez les
              gérer.
            </p>
          </div>
          ...
          <div className="space-y-8 font-light text-[#666666] leading-relaxed">
            <section>
              ...
              <p>
                ...
                tablette, smartphone) lors de la visite d&apos;un site. Les cookies permettent de
                collecter des informations relatives à votre navigation et de vous offrir des
            ...
            <section>
              ...
              <div className="mt-6 space-y-6">
                <div className="p-5 bg-[#FAFAFA] border border-[#E5E5E5]">
                  ...
                  <p className="text-sm">
                    Ces cookies sont strictement nécessaires au fonctionnement du site. Ils ne
                  ...
                  <ul className="mt-3 space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>token :</strong> Maintient votre session utilisateur sécurisée
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="inline-block w-2 h-2 mt-1.5 bg-[#0066FF] rounded-full flex-shrink-0"></span>
                      <span>
                        <strong>auth :</strong> Gère l&apos;authentification et les permissions
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="p-5 bg-[#FAFAFA] border border-[#E5E5E5]">
                  ...
                  <p className="text-sm">
                    Ces cookies permettent de mémoriser vos préférences et choix (langue, région,
                    etc.).
                  </p>
                  <ul className="mt-3 space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>tarteaucitron :</strong> Enregistre vos préférences de consentement
                        aux cookies
                      </span>
                    </li>
                  </ul>
                ...
                <div className="p-5 bg-[#FAFAFA] border border-[#E5E5E5]">
                  ...
                  <p className="text-sm">
                    ...
                    notre site en collectant des informations anonymes.
                  </p>
                  <ul className="mt-3 space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="inline-block w-2 h-2 mt-1.5 bg-[#F59E0B] rounded-full flex-shrink-0"></span>
                      <span>
                        <strong>_ga, _gid :</strong> Analytics (Google Analytics) - non activé
                        actuellement
                      </span>
                    </li>
                  </ul>
                ...
                <div className="p-5 bg-[#FAFAFA] border border-[#E5E5E5]">
                  ...
                  <p className="text-sm">
                    Ces cookies sont utilisés pour diffuser des publicités plus pertinentes pour
                    vous.
                  </p>
                  <ul className="mt-3 space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Publicité ciblée :</strong> Nous n&apos;utilisons pas de cookies
                        marketing actuellement
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <section>
              ...
              <p>
                Vous pouvez à tout moment modifier vos préférences concernant les cookies. Vos choix
                s&apos;appliqueront uniquement à ce site.
              </p>
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <button
                  ...
                  title={
                    !tarteaucitronReady
                      ? 'Le gestionnaire de cookies est en cours de chargement'
                      : ''
                  }
                >
              ...
              <div className="mt-6 p-4 bg-[#FAFAFA] border border-[#E5E5E5]">
                <p className="text-sm">
                  <strong>Note :</strong> Le refus des cookies essentiels rendra impossible
                  l&apos;utilisation de certaines fonctionnalités du site, comme la connexion à
                  votre compte ou la gestion des réservations.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p>Les cookies sont conservés pour des durées variables en fonction de leur type :</p>
              <ul className="list-disc pl-6 space-y-2 mt-2">
                <li>
                  <strong>Cookies de session :</strong> Supprimés à la fermeture du navigateur
                </li>
                <li>
                  <strong>Cookies persistants :</strong> Conservés jusqu&apos;à leur date
                  d&apos;expiration ou jusqu&apos;à ce que vous les supprimiez
                </li>
                <li>
                  <strong>Cookie de consentement :</strong> Conservé pendant 13 mois
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                rectification, d&apos;effacement et d&apos;opposition aux données vous concernant.
              </p>
              <p className="mt-2">
                Pour exercer ces droits ou pour toute question relative à notre utilisation des
                cookies, contactez-nous à :{' '}
                <a href="mailto:privacy@tablemaster.fr" className="text-[#0066FF] hover:underline">
                  privacy@tablemaster.fr
                </a>
              </p>
            </section>
          </div>
