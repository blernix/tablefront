...
const siteUrl = 'https://tablemaster.killian-lecrut.com';
...
export const pageMetadata: PageMetadata = {
  ...
  '/': {
    ...
    description: 'Stoppez les 15% de commission sur vos réservations. Installation 1 minute. Gérez réservations et avis Google depuis mobile. Tarif fixe 39€/mois. Sans engagement, résiliable à tout moment.',
    ...
    openGraph: {
      title: 'TableMaster - Système de Réservation sans Commission | 39€/mois',
      description: 'Stoppez les 15% de commission sur vos réservations. Installation 1 minute. Gérez réservations et avis Google depuis mobile.',
      type: 'website',
      locale: 'fr_FR',
      url: siteUrl,
  ...
  '/privacy': {
    ...
    description: 'Politique de confidentialité de TableMaster. Gestion des données personnelles, droits des utilisateurs, cookies.',
    alternates: {
      canonical: `${siteUrl}/privacy`,
    },
    openGraph: {
      title: 'Politique de Confidentialité - TableMaster',
      description: 'Politique de confidentialité de TableMaster. Gestion des données personnelles, droits des utilisateurs.',
      type: 'article',
      url: `${siteUrl}/privacy`,
    },
    twitter: {
  ...
  '/cookies': {
    ...
    description: 'Gestion des cookies sur TableMaster. Types de cookies utilisés, préférences, consentement.',
    alternates: {
  ...
  '/cgv': {
    ...
    description: 'Conditions Générales de Vente et d\'Utilisation de TableMaster. Droits et obligations, tarifs, support.',
    alternates: {
  ...
  '/dashboard': {
    ...
    description: 'Tableau de bord TableMaster. Gérez vos réservations, statistiques, paramètres et équipe.',
    alternates: {
...
export const defaultMetadata: Metadata = {
  ...
  description: 'Stoppez les 15% de commission sur vos réservations. Installation 1 minute. Tarif fixe 39€/mois.',
  alternates: {
    canonical: siteUrl,
  },
  openGraph: {
...
export const organizationStructuredData = {
  ...
  sameAs: [
    'https://www.linkedin.com/company/tablemaster',
  ],
  contactPoint: {
    '@type': 'ContactPoint',
