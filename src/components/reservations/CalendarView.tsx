          ...
          return (
            ...
            >
              <div className="flex flex-col items-center justify-center h-full">
                <div
                  className={`text-sm font-semibold mb-1 ${isTodayDate ? 'text-blue-600' : 'text-gray-900'}`}
                >
                  {day}
                </div>
                {stats.count > 0 && (
                  <div className="text-xs space-y-0.5">
                    <div className="font-medium text-gray-700">{stats.count} rés.</div>
                    <div className="text-gray-600">{stats.guests} pers.</div>
                  </div>
                )}
              </div>
            </button>
